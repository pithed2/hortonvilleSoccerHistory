      ...
      <div className="site-container">
        <div className="surface-card overflow-hidden sm:flex sm:items-center">
          <div className="shrink-0 bg-black sm:w-60">
            <Image
              src="/images/hortonville-wsca-week-4-2026.png"
              alt="Hortonville boys soccer: state ranked No. 9 in Division 1, Week 4 of the 2026 WSCA poll"
              width={1122}
              height={1402}
          ...
          <div className="p-6 sm:p-8 lg:p-10">
            <p className="section-eyebrow">WSCA Coaches Poll · Week 4 · 2026</p>
            <h2 id="state-ranking-title" className="section-title">No. 9 in Wisconsin Division 1</h2>
            <p className="mt-4 max-w-xl text-base leading-7 text-muted-foreground">
              The Polar Bears earned the No. 9 spot in the 2026 Week 4 WSCA Division 1 Coaches Poll.
              The rankings committee saw the competitive battle between Hortonville and De Pere!
            </p>
