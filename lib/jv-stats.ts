...
export const jvStats = {
  ...
  record: { wins: 2, losses: 2, ties: 0, conference: "1–1–0" },
  totals: { goalsFor: 18, goalsAgainst: 5, shots: 87, sog: 50, saves: 16 },
  recent: [
  ...
  upcoming: [
    { date: "Sep 3", opponent: "Oshkosh North", location: "Away" },
    { date: "Sep 10", opponent: "Fond du Lac", location: "Home" },
    { date: "Sep 15", opponent: "Neenah", location: "Away" },
  ],
  players: [
    { number: 22, name: "Amos Arndt", gp: 4, goals: 5, assists: 1, points: 11 },
    { number: 6, name: "Parker Anderson", gp: 4, goals: 2, assists: 1, points: 5 },
    { number: 15, name: "Sam Radle", gp: 4, goals: 2, assists: 1, points: 5 },
    { number: 19, name: "Timmy VanSchyndel", gp: 4, goals: 2, assists: 1, points: 5 },
    { number: 14, name: "Owen Pavich", gp: 4, goals: 1, assists: 3, points: 5 },
    { number: 12, name: "Brody Schroeder", gp: 4, goals: 2, assists: 0, points: 4 },
    { number: 20, name: "Beckett Feldbruegge", gp: 4, goals: 2, assists: 0, points: 4 },
    { number: 9, name: "Ben Parker", gp: 4, goals: 0, assists: 3, points: 3 },
    { number: 10, name: "Hunter Hasseler", gp: 4, goals: 1, assists: 1, points: 3 },
    { number: 18, name: "Grayson Ackermann", gp: 4, goals: 1, assists: 0, points: 2 },
    { number: 8, name: "Oliver Plamann", gp: 4, goals: 0, assists: 1, points: 1 },
    { number: 23, name: "Jaxon Wolff", gp: 4, goals: 0, assists: 1, points: 1 },
    { number: 24, name: "Ethen LaPlant", gp: 4, goals: 0, assists: 1, points: 1 },
    { number: 26, name: "Leon Ryzhov", gp: 4, goals: 0, assists: 1, points: 1 },
    { number: 2, name: "Parker Rugotska", gp: 4, goals: 0, assists: 0, points: 0 },
    { number: 3, name: "Dylan McFarlane", gp: 4, goals: 0, assists: 0, points: 0 },
    { number: 4, name: "Weston Ehr", gp: 4, goals: 0, assists: 0, points: 0 },
    { number: 5, name: "Nolan Raaths", gp: 4, goals: 0, assists: 0, points: 0 },
    { number: 7, name: "Isaac Reiland", gp: 0, goals: 0, assists: 0, points: 0 },
    { number: 11, name: "Jaxton Seefeldt", gp: 4, goals: 0, assists: 0, points: 0 },
    { number: 13, name: "Aaron Young", gp: 4, goals: 0, assists: 0, points: 0 },
    { number: 16, name: "Carson Sanford", gp: 4, goals: 0, assists: 0, points: 0 },
    { number: 17, name: "Henri Waite", gp: 4, goals: 0, assists: 0, points: 0 },
    { number: 21, name: "Easton Slomski", gp: 4, goals: 0, assists: 0, points: 0 },
    { number: 31, name: "Henri Waite", gp: 4, goals: 0, assists: 0, points: 0 },
  ],
}
